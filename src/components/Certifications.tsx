        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 text-center hover:shadow-lg transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-800 mb-2">HKU Undergraduate Entrance Scholarship</h4>
              <p className="text-gray-600 text-sm">President's Scholars (2022-26)</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm mb-3">Professional Certificate</p>
              <a 
                href="https://www.coursera.org/account/accomplishments/professional-cert/EXTZSM8Z75RV" 
                target="_blank" 
